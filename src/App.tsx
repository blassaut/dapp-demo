    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-3">
          <h1 className="text-lg font-heading font-bold text-light mb-0.5">LockBox — on-chain deposit vault</h1>
          <p className="text-[11px] font-mono text-teal-400/50">Live transactions on Hoodi testnet · tested end-to-end</p>
        </div>
